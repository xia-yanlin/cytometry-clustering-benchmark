...
Raw event-level matrices are not needed to rebuild the manuscript displays. The frozen tables under `analysis/inputs` and the contingency tables under `posthoc/source` are included for that purpose.
